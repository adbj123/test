<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"G:\TP\public/../application/admin\view\index\main.html";i:1534605350;}*/ ?>
...
<body>
    ...
    <div class="mainindex">
        <div class="welinfo">
            <span><img src="<?php echo config('static_admin'); ?>/images/sun.png" alt="天气" /></span>
            <b>Admin早上好，欢迎使用商品管理系统</b>(admin@uimaker.com)
            <a href="#">帐号设置</a>
        </div>
        <div class="welinfo">
            <span><img src="<?php echo config('static_admin'); ?>/images/time.png" alt="时间" /></span>
            <i>您上次登录的时间：2013-10-09 15:22</i>
        </div>
        <div class="xline"></div>
        <div class="box"></div>
        <div class="welinfo">
            <span><img src="<?php echo config('static_admin'); ?>/images/dp.png" alt="提醒" /></span>
            <b>环境信息</b>
        </div>
        <ul class="infolist">
