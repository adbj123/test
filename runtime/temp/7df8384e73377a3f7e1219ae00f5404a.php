<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"G:\TP\public/../application/admin\view\order\setWuliu.html";i:1535698899;}*/ ?>
...
<div class="formbody">
    ...
    <form action="" method="post">
        ...
        <ul class="forminfo">
            <li>
                <label>订单号</label>
                <input  readonly="readonly" value="<?php echo $orderData['order_id']; ?>" placeholder="请输入用户名" type="text" class="dfinput" /><i></i>
            </li>
            <li>
                <label>请选择物流公司</label>
            ...
            <li>
                <label>运单号</label>
                <input name="number" placeholder="请输入运单号" type="text" class="dfinput" />
            </li>
