<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"G:\TP\public/../application/admin\view\category\index.html";i:1534936006;}*/ ?>
...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <td><?php echo str_repeat('--',$v['level']*4); ?><?php echo $v['cat_name']; ?></td>
            <td><?php echo $cats[ $v['pid'] ]['cat_name']; ?></td>
            <td><?php echo config('is_show')[ $v['is_show'] ]; ?></td>

            <td>
                <a href="<?php echo url('/admin/category/upd',['cat_id'=>$v['cat_id']]); ?>" class="tablelink">编辑
                </a>
                <a href="<?php echo url('/admin/category/del',['cat_id'=>$v['cat_id']]); ?>" onclick="return confirm('确认删除?')" class="tablelink"> 删除
                </a>
            </td>
        </tr>
