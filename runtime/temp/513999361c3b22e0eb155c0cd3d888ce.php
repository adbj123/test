<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"G:\TP\public/../application/admin\view\attribute\index.html";i:1534857932;}*/ ?>
...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
        <?php if(is_array($attrsData) || $attrsData instanceof \think\Collection || $attrsData instanceof \think\Paginator): if( count($attrsData)==0 ) : echo "" ;else: foreach($attrsData as $key=>$v): ?>
        <tr>
            <td>
            ...
            <td >
                ...
                <a href="<?php echo url('/admin/attribute/upd',['attr_id'=>$v['attr_id']]); ?>" class="tablelink">编辑
                </a>
                <a href="<?php echo url('/admin/attribute/del',['attr_id'=>$v['attr_id']]); ?>" onclick="return confirm('确认删除?')" class="tablelink"> 删除
                </a>
            </td>
        </tr>
