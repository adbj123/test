<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"G:\TP\public/../application/admin\view\attribute\upd.html";i:1534901867;}*/ ?>
...
<div class="formbody">
    ...
    <form action="" method="post">
        ...
        <ul class="forminfo">
            <li>
                <label>属性名称</label>
                <input name="attr_name" value="<?php echo $attrData['attr_name']; ?>" placeholder="请输入属性名称" type="text" class="dfinput" /><i></i>
            </li>
            <li>
                <label>选择商品类型</label>
            ...
            <li>
                <label>属性值</label>
                <textarea name="attr_values" class="textinput" placeholder="多个值用|隔开"><?php echo $attrData['attr_values']; ?></textarea>
                <i>多个值用|隔开</i>
            </li>
        </ul>
        <li>
