<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"G:\TP\public/../application/home\view\cart\cartlist.html";i:1535799395;s:43:"G:\TP\application\home\view\public\nav.html";i:1535724302;s:44:"G:\TP\application\home\view\public\foot.html";i:1535799395;}*/ ?>
...
<head>
	...
	<script type="text/javascript" src="<?php echo config('static_home'); ?>/js/cart1.js?v=3"></script>
...
<script>
    ...
    $(".delCartGoods").click(function () {
       ...
       //发送ajax请求，进行删除
        $.get("<?php echo url('/home/cart/delCartGoods'); ?>",param,function (res) {
            console.log(res);
            if(res.code == 200){
