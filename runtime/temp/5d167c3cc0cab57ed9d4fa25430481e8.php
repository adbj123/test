<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"G:\TP\public/../application/admin\view\auth\index.html";i:1534680170;}*/ ?>
...
<body>
    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($authsData) || $authsData instanceof \think\Collection || $authsData instanceof \think\Paginator): if( count($authsData)==0 ) : echo "" ;else: foreach($authsData as $key=>$v): ?>
                <tr>
                    <td>
                        <input name="" type="checkbox" value="" />
                    </td>
                    <td><?php echo $key+1; ?></td>
                    <td><?php echo str_repeat('--- ',$v['level']); ?><?php echo $v['auth_name']; ?></td>
                    <td><?php echo $v['p_name']; ?></td>
                    <td><?php echo $v['auth_c']; ?></td>
                    <td><?php echo $v['auth_a']; ?></td>
                    <td><a href="<?php echo url('/admin/auth/upd',['auth_id'=>$v['auth_id']]); ?>" class="tablelink">修改</a> <a href="<?php echo url('/admin/auth/del',['auth_id'=>$v['auth_id']]); ?>" onclick="return confirm('确认删除？')" class="tablelink"> 删除</a></td>
                </tr>
