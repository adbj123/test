<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"G:\TP\public/../application/admin\view\role\add.html";i:1534939700;}*/ ?>
...
<div class="formbody">
    ...
    <form action="" method="post">
        <ul class="forminfo">
            <li>
                <label>角色名称</label>
                <input name="role_name" placeholder="请输入权限名称" type="text" class="dfinput" /><i></i>
            </li>
            <li>
                分配权限：
