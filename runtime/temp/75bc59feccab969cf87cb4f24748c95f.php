<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"G:\TP\public/../application/admin\view\user\upd.html";i:1534605350;}*/ ?>
    ...
    <div class="formbody">
        ...
        <form action="" method="post">
            ...
            <ul class="forminfo">
                <li>
                    <label>用户名</label>
                    <input name="username" readonly="readonly" value="<?php echo $userData['username']; ?>" placeholder="请输入用户名" type="text" class="dfinput" /><i></i>
                </li>
                <li>
                    <label>密码</label>
                ...
                <li>
                    <label>确认密码</label>
                    <input name="repassword" placeholder="请输入确认密码" type="text" class="dfinput" />
                </li>
			<li>
                    <label>&nbsp;</label>
