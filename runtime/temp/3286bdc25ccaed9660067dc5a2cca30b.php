<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:56:"G:\TP\public/../application/admin\view\public\login.html";i:1534605350;}*/ ?>
...
<head>
    ...
    <script src="<?php echo config('static_admin'); ?>/js/cloud.js" type="text/javascript"></script>
...
<body style="background-color:#1c77ac; background-image:url(<?php echo config('static_admin'); ?>/images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    <div id="mainBody">
            ...
            <div class="loginbox">
                <ul>
                    ...
                    <li>
                        ...
                        <img src="<?php echo captcha_src(); ?>" alt='验证码' id='changeCaptcha' />
                    </li>
                    <li>
