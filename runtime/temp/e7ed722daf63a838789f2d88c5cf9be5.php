<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"G:\TP\public/../application/home\view\public\login.html";i:1535705907;}*/ ?>
	...
	<div class="login w990 bc mt10">
		...
		<div class="login_bd">
			<div class="login_form fl">
				<form action="" method="post">
					<ul>
						...
						<li class="checkcode">
							...
							<img src="<?php echo captcha_src('2'); ?>" alt="" id="login_captcha"/>
				...
				<div class="coagent mt15">
					<dl>
						...
						<dd class="weibo"><a href="<?php echo config('static_home'); ?>/"><span></span>新浪微博</a></dd>
						<dd class="yi"><a href="<?php echo config('static_home'); ?>/"><span></span>网易</a></dd>
						<dd class="renren"><a href="<?php echo config('static_home'); ?>/"><span></span>人人</a></dd>
						<dd class="qihu"><a href="<?php echo config('static_home'); ?>/"><span></span>奇虎360</a></dd>
						<dd class=""><a href="<?php echo config('static_home'); ?>/"><span></span>百度</a></dd>
						<dd class="douban"><a href="<?php echo config('static_home'); ?>/"><span></span>豆瓣</a></dd>
					</dl>
				</div>
			</div>
			...
			<div class="guide fl">
				...
				<a href="<?php echo url('/home/public/register'); ?>" class="reg_btn">免费注册 >></a>
			</div>
...
<script>
    ...
    $("#changeCaptcha").click(function() {
        $("#login_captcha").attr('src',"<?php echo captcha_src('2'); ?>?_="+Math.random());
    });
    $("#changeCaptcha").click();
</script>
</html>