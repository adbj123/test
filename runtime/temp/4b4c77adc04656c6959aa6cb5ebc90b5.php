<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"G:\TP\public/../application/admin\view\role\index.html";i:1534817155;}*/ ?>
...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
        <?php if(is_array($rolesData) || $rolesData instanceof \think\Collection || $rolesData instanceof \think\Paginator): if( count($rolesData)==0 ) : echo "" ;else: foreach($rolesData as $key=>$v): ?>
        <tr>
            <td>
            ...
            <td><?php echo $v['all_auth']; ?></td>

            <td auth_ids_list="<?php echo $v['auth_ids_list']; ?>"><a href="<?php echo url('/admin/role/upd',['role_id'=>$v['role_id']]); ?>" class="tablelink">修改</a> <a href="<?php echo url('/admin/role/del',['role_id'=>$v['role_id']]); ?>" onclick="return confirm('确认删除？')" class="tablelink"> 删除</a></td>
        </tr>
